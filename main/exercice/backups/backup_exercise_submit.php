...
/**
 * Generating the time control key for the user [PER QUESTION]
 * 
 * @ Author - Serge Bayol
 * 
 */
        
 //echo'$objQuestion->chrono = '. $objQuestion->chrono; // @ serge temp
 //echo '$info_chrono exercice_submit.php : '.$info_chrono;
// $current_expired_time_key = get_time_control_key($objExercise->id, $learnpath_id, $learnpath_item_id);
        
if ($objQuestion->chrono != 0) {
	$time_control = true;
}
