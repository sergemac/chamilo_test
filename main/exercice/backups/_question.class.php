  ...
  */       
    ...
    */
	 ...
	 */
	 ...
	 //$form->addElement('checkbox', 'chronoQuestion', get_lang('ChronoQuest'), $chronQuest);
            $diplay = 'block';
		   ...
		   //$expired_date = '0';
            ...
            $form->addElement('text', 'enabletimercontroltotalminutes',get_lang('QuestionTotalDurationSecondes'),array('style' => 'width : 35px','id' => 'enabletimercontroltotalminutes'));
            $form->addElement('html','</div>');
