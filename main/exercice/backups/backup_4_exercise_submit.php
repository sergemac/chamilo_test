...
$chrono_media = $objQuestionTmp->chronoMedia(); // @ Serge Bayol - Countdown start after the complete merdia reading
if ($chronoquest != 0){
?>
<script>
$(document).ready(function() {
 ...
 function capture() {
    ...
    //console.log('real time left dans capture = '+real_time_left);
